      ...
      const token = sessionStorage.getItem("token");
       ...
       try {
        axios
          ...
          .then((response) => {
            ...
            if (response.data.message === "Success!"){
               ...
               setCat_status(true);
               setCat1(false)
            }else if(response.data.message === "Category-type not inserted."){
              setCat_typeFlag(false);
              toast_message("warning");
              setCat_typeError("Category-type not inserted.");
            }else if (response.data.message === "Category-type already exists.") {
              setCat_typeFlag(false);
              toast_message("warning");
        ...
        const handleCategory = (e) => {
          ...
          /******* Description *******/
          if (category_description.trim().length === 0 || category_description.trim().length > 10) {
        ...
        if (cat_titleFlag === true && category_desFlag === true && catidflag === true) {
          console.log("valid");
          const token = sessionStorage.getItem("token");
          const headers = { Authorization: `Bearer ${token}` };
          try {
        ...
        <div className="add-suplier">
          ...
          <div className="add-suplier-sub1">
            ...
            <div className="box">
              ...
              />
              {cat3 && (
                <p className="error-color">{cat_titleError}</p>
              )}
            </div>
            <div className="box">
              ...
              />
              {cat4 && (
                <p className="error-color">{category_desError}</p>
              )}
            </div>
            <div className="box">
              <p>Category Status</p>
